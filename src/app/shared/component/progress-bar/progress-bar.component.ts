...
export class ProgressBarComponent implements OnInit {
  ...
  status: string[] = [
    ...
    'Starting Deployment Server (This may take as long as 15 min. Please be patient)...',
    'Running Deployment Server (This may take as long as 15 min. Please be patient) ...',
